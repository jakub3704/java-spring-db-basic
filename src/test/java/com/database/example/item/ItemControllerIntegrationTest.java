...
public class ItemControllerIntegrationTest {
	...
	public void getItemTest() throws Exception {
		...
		result.andExpect(jsonPath("$.id", is(items.get(1).getId().intValue())))
			  .andExpect(jsonPath("$.name", is("B Name"))).andExpect(jsonPath("$.description", is("B Description")));
	}

	@Test
	public void createItemTest() throws Exception {
		ResultActions result = mvc
				.perform(MockMvcRequestBuilders.post("/item").contentType("application/json;charset=UTF-8")
